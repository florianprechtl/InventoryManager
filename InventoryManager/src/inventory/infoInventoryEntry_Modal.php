                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            ...
                            <input class="form-control" disabled name="date_buying" type="text" pattern="(0[1-9]|1[0-9]|2[0-9]|3[01]).(0[1-9]|1[012]).[0-9]{4}" id="buying_date_<?php echo $inventoryEntryNr ?>" value="<?=$inventoryEntry->buyingDate?>">
                        </div>
                        <div class="col-sm-6 form-group">
                            <label for="date_expiring">Expiring date</label><br>
                            <input class="form-control" disabled name="date_expiring" type="text" pattern="(0[1-9]|1[0-9]|2[0-9]|3[01]).(0[1-9]|1[012]).[0-9]{4}" id="expiring_date_<?php echo $inventoryEntryNr ?>" value="<?=$inventoryEntry->expiringDate?>">
                        </div>
                    </div>
                </div>
